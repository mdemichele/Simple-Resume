...
function loadArxiv() {
  ...
  xhr.open("GET", "http://export.arxiv.org/api/query?search_query=cat:cs.LG+AND+cat:cs.GT+AND+cat:cs.DS&sortBy=lastUpdatedDate&sortOrder=descending&start=0&max_results=10", true);
